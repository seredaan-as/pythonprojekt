...
from functionsstorage import read_int, filter_by_time, filter_by_complexity, filter_by_diet, filter_by_course, get_random_recipe  
import time
...
def find_recipe_flow():
    ...
    if choice == 1:
        ...
        time.sleep(2)
        show_main_menu()                    # Zurück ins Hauptmenü
    else:
